...
export declare class DevvitVersion {
    ...
    static fromProtoAppVersionInfo(version: Pick<AppVersionInfo, 'majorVersion' | 'minorVersion' | 'patchVersion'> & Partial<Pick<AppVersionInfo, 'prereleaseVersion'>>): DevvitVersion;
