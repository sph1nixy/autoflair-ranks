...
export const DataSubscription = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.concurrentConnections !== 0) {
            writer.uint32(72).int32(message.concurrentConnections);
        }
        if (message.duration !== undefined) {
            Duration.encode(message.duration, writer.uint32(82).fork()).ldelim();
        }
        if (message.compliance !== false) {
            writer.uint32(88).bool(message.compliance);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    message.concurrentConnections = reader.int32();
                    continue;
                case 10:
                    if (tag !== 82) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            concurrentConnections: isSet(object.concurrentConnections) ? globalThis.Number(object.concurrentConnections) : 0,
    ...
    toJSON(message) {
        ...
        if (message.concurrentConnections !== 0) {
            obj.concurrentConnections = Math.round(message.concurrentConnections);
        }
        if (message.duration !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.concurrentConnections = object.concurrentConnections ?? 0;
