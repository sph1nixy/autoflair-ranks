...
export var Source;
(function (Source) {
    Source[Source["SNOORON_WORKER_DEVVIT"] = 0] = "SNOORON_WORKER_DEVVIT";
    Source[Source["EVALUATOR"] = 1] = "EVALUATOR";
    Source[Source["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Source || (Source = {}));
export function sourceFromJSON(object) {
    switch (object) {
        case 0:
        case "SNOORON_WORKER_DEVVIT":
            return Source.SNOORON_WORKER_DEVVIT;
        case 1:
        case "EVALUATOR":
...
export function sourceToJSON(object) {
    switch (object) {
        case Source.SNOORON_WORKER_DEVVIT:
            return 0;
        case Source.EVALUATOR:
            return 1;
...
function createBaseTriggerInvocation() {
    return { installationId: "", evt: undefined, source: 0 };
}
