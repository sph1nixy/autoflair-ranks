...
export const AppVersionCreationRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.sourceSize !== undefined) {
            writer.uint32(104).int32(message.sourceSize);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            sourceSize: isSet(object.sourceSize) ? globalThis.Number(object.sourceSize) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.sourceSize !== undefined) {
            obj.sourceSize = Math.round(message.sourceSize);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.sourceSize = object.sourceSize ?? undefined;
        return message;
    },
};
