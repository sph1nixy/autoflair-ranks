...
export const InstallationUpdateRequest = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10:
                    if (tag === 80) {
                        message.computeClusters.push(reader.int32());
                        continue;
                    }
                    if (tag === 82) {
    ...
    fromJSON(object) {
        return {
            ...
            computeClusters: globalThis.Array.isArray(object?.computeClusters)
                ? object.computeClusters.map((e) => computeClusterFromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.computeClusters?.length) {
            obj.computeClusters = message.computeClusters.map((e) => computeClusterToJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.computeClusters = object.computeClusters?.map((e) => e) || [];
        return message;
    },
};
